...
class ScanService:
    ...
    async def process_scan(
        ...
        try:
            ...
            if pipeline_output.get("crop_path"):
                files_to_cleanup.append(pipeline_output["crop_path"])
            if pipeline_output.get("heatmap_path"):
                files_to_cleanup.append(pipeline_output["heatmap_path"])
    ...
    async def process_dual_scan(
        ...
        files_to_cleanup = [rel_front, rel_back]
        ...
        try:
            ...
            for img_info in images_info:
                ...
                if img_info.get("crop_path"):
                    files_to_cleanup.append(img_info["crop_path"])
                if img_info.get("heatmap_path"):
                    files_to_cleanup.append(img_info["heatmap_path"])
